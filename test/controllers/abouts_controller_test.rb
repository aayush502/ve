...
class AboutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create about" do
    assert_difference('About.count') do
      post abouts_url, params: { about: { privacy: @about.privacy, terms_and_condition: @about.terms_and_condition, thank_you: @about.thank_you, welcome: @about.welcome } }
    end
  ...
  test "should update about" do
    patch about_url(@about), params: { about: { privacy: @about.privacy, terms_and_condition: @about.terms_and_condition, thank_you: @about.thank_you, welcome: @about.welcome } }
